...
def toFile(result: String): Unit = {
  val pw = new BufferedWriter(new FileWriter(new File("fullparse.txt")))
  pw.write(result)
  pw.close()
}
...
println("\ttoFile(STRING, such as res7)")
